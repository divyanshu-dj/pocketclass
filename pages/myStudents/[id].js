  ...
  return (
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-gray-600">
                    Import your client list in minutes to streamline your client
                    management and track sales performance
                  </p>
                </div>
              </div>
              <button
                ...
                {filteredData.length === 0 ? (
                  ...
                  filteredData.map((client, index) => (
                    <div
                      ...
                      className="p-3 sm:p-4 lg:px-6 lg:py-4 hover:bg-gray-50/50 transition-colors"
                    >
                      {/* Desktop Layout */}
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewClient({ ...newClient, totalSales: e.target.value })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#E63F2B] focus:border-transparent text-sm"
                  />
    ...
    {client && (
      <>.
        ...
        {/* Side Panel */}
        <div style={{zIndex: 990}} className="fixed top-0 right-0 h-full w-full max-h-screen lg:max-w-[80%] bg-white shadow-2xl">
