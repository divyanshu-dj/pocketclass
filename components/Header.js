        ...
        <header className='sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10'>
            ...
            <div className='flex items-center md:border-2 rounded-full py-2 md:shadow-sm'>
                <input value={searchInput} id="searchInputId"
                    onChange={(e) => setSearchInput(e.target.value)} type="text" placeholder={placeholder || "tennis, painting, violin..."} className='text-gray-600 placeholder-gray-400 text-sm flex-grow pl-5 bg-transparent border-none focus:outline-none' />
