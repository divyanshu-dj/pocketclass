...
export default function LoginForm({ setAuthState, setUser }) {
	return (
		<div className="w-11/12 max-w-[700px] px-10 py-20 rounded-3xl">
			...
			<div className="mt-8">
				...
				<div className="mt-8 flex justify-between items-center">
					...
					<button className="font-medium text-sm text-logo-red">
						Forgot password
					</button>
				</div>
				<div className="mt-8 flex flex-col gap-y-4">
					...
					<button className="flex items-center justify-center gap-2 active:scale-105 active:duration-75 transition-all hover:scale-[1.01]  ease-in-out transform py-4  rounded-xl text-gray-700 font-semibold text-lg border-2 border-gray-100 ">
						<svg
							width="24"
							height="24"
							viewBox="0 0 24 24"
