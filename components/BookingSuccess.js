    ...
    <div className="flex flex-col items-center px-5 py-0 mt-12 max-w-full text-center w-[916px] max-md:px-8 max-md:py-0 max-md:w-full max-sm:px-4 max-sm:py-0">
      ...
      <div>
        ...
        <p className="mb-4 text-base font-medium leading-6 text-black">
          You're all set to enjoy your PocketClass experience. A confirmation email with the details of your booking has been sent to your inbox. If you have any questions or need assistance, feel free to reach out to our support team.
        </p>
        <p className="mb-4 text-base font-medium leading-6 text-black">
