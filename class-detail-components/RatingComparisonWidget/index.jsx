  ...
  return (
    <div className="flex justify-start items-start flex-row gap-4 md:gap-[22.5px] max-w-[480px] grow-0 shrink basis-auto box-border md:ml-[23.5px]">
      ...
      <div className="grow-0 shrink basis-[122px] box-border">
        <p className="[font-family:'DM_Sans',sans-serif] text-base md:text-lg font-bold text-left leading-7 text-[#261f22] w-[100.00%] box-border m-0 p-0">Recommend</p>
      ...
      <div className="grow-0 shrink basis-[121px] box-border">
        <p className="[font-family:'DM_Sans',sans-serif] text-base md:text-lg font-bold text-left leading-7 text-[#261f22] w-[100.00%] box-border m-0 p-0">Quality</p>
      ...
      <div className="h-[124px] box-border w-px grow-0 shrink-0 basis-auto border-l-[#d4d2d3] border-l border-solid" />
      <div className="grow-0 shrink basis-[122px] box-border">
        <p className="[font-family:'DM_Sans',sans-serif] text-base md:text-lg leading-7 font-bold text-[#261f22] m-0 p-0">Safety</p>
        <p className="[font-family:'DM_Sans',sans-serif] text-[32px] font-bold text-center leading-8 text-[#261f22] box-border mt-12 m-0 p-0"  style={{textAlign:'center'}}>{avgSafety.toFixed(1)}</p>
      </div>
    </div>
  );
}
