...
function SuperInstructorBox() {
  return (
    <div className="box-border flex justify-start items-stretch flex-row grow-0 shrink-0 basis-auto pt-4 pb-[172px] px-4 rounded-[16px_16px_0px_0px]">
...
export default SuperInstructorBox;
